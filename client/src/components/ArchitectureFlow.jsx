    ...
    >
            ...
            {architecture.stages.map((stage, index) => (
              <div key={stage.name} className="flex-1">
                ...
                >
                  ...
                  <div className="text-xs opacity-80">{stage.service}</div>
                  {stage.time && (
                    <div className="text-xs font-mono mt-1 font-semibold">{stage.time}</div>
                  )}
                </div>
      ...
      {architecture.searchMode && (
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          `}
          >
            <div className="text-xs uppercase tracking-wider opacity-60 mb-1">Search Mode</div>
          ...
          `}
          >
            <div className="text-xs uppercase tracking-wider opacity-60 mb-1">LLM Provider</div>
            <div className="text-sm font-medium">
      ...
      {architecture.flow && (
        ...
        >
          ...
          <div className="font-mono opacity-80">{architecture.flow}</div>
        </div>
      )}
