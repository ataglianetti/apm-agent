...
const QUICK_LOOKUP = {
  ...
  'acoustic guitar': {
    ...
    id: 3001,
    label: 'Guitar, Acoustic / Nylon String',
  },
  ...
  'electronic drums': {
    category: 'Instruments',
    id: 2936,
    label: 'Drum Machine / Electronic Drums',
  },
  ...
  'tubular bells': {
    category: 'Instruments',
    id: 2924,
    label: 'Tubular Bells / Church Bells / Chimes',
  },
  ...
  'middle eastern influenced': {
    category: 'Additional Genre',
    id: 1999,
    label: 'Middle Eastern Influenced',
  },
  ...
  'very very slow': {
    category: 'Tempo',
    id: 1874,
    label: 'Below 40 Very, Very Slow (Larghissimo)',
  },
  ...
  'very very fast': {
    category: 'Tempo',
    id: 1882,
    label: 'Over 200 Very, Very Fast (Prestissimo)',
  },
  ...
  'grandfather clock': {
    ...
    id: 1487,
    label: 'Clockwork / Grandfather Clock',
  },
  ...
  // Orchestral
  'symphony orchestra': {
    category: 'Instrumental & Vocal Groupings',
    id: 1409,
  ...
  'chamber orchestra': {
    category: 'Instrumental & Vocal Groupings',
    id: 1410,
    label: 'Chamber Orchestra / Small Orchestra',
  },
  'small orchestra': {
    category: 'Instrumental & Vocal Groupings',
    id: 1410,
  ...
  'palm court': {
    category: 'Instrumental & Vocal Groupings',
    id: 1411,
    label: 'Palm Court / Salon Orchestra',
  },
  'salon orchestra': {
    category: 'Instrumental & Vocal Groupings',
    id: 1411,
  ...
  'chamber music': {
    category: 'Instrumental & Vocal Groupings',
    id: 1412,
    label: 'Chamber Music / Classical Ensemble',
  },
  'classical ensemble': {
    category: 'Instrumental & Vocal Groupings',
    id: 1412,
  ...
  'country band': {
    category: 'Instrumental & Vocal Groupings',
    id: 1391,
    label: 'Country and Western Band',
  },
  ...
  'street musicians': {
    category: 'Instrumental & Vocal Groupings',
    id: 1405,
    label: 'Street Musicians',
  },
  'walking bass and drums': {
    category: 'Instrumental & Vocal Groupings',
    id: 1406,
    label: 'Walking Bass & Drums',
  },
  ...
  'woodwind section': {
    category: 'Instrumental & Vocal Groupings',
    id: 1429,
    label: 'Woodwind Section',
  },
  'woodwind ensemble': {
    category: 'Instrumental & Vocal Groupings',
    id: 1428,
    label: 'Woodwind Ensemble',
  },
  ...
  'taiko group': {
    category: 'Instrumental & Vocal Groupings',
    id: 1440,
    label: 'Kodo Drummers / Taiko Group',
  },
  'kodo drummers': {
    category: 'Instrumental & Vocal Groupings',
    id: 1440,
  ...
  // Children / Youth TV Programming
  // Note: contentLabel = Solr value, label = display value (when they differ)
  'children youth tv': {
    category: 'Music For',
    id: 2648,
    label: 'Children & Youth TV',
    contentLabel: 'Children/Youth TV',
  },
  'kids tv': {
    category: 'Music For',
    id: 2648,
  ...
  tweens: { category: 'Music For', id: 2650, label: 'Tweens TV', contentLabel: 'Tweens' },
  'tweens tv': { category: 'Music For', id: 2650, label: 'Tweens TV', contentLabel: 'Tweens' },
  'pre school': {
    category: 'Music For',
    id: 2649,
    label: 'Pre School TV',
    contentLabel: 'Pre School',
  },
  preschool: {
    category: 'Music For',
    id: 2649,
  ...
  // Note: preschool entries moved to Children / Youth TV Programming section above
  ...
  elevator: {
    category: 'Music For',
    id: 2572,
    label: 'Elevator / On Hold / Retail Background Music',
  },
  'on hold': {
    category: 'Music For',
    id: 2572,
  ...
  'ancient greece': {
    ...
    id: 1785,
    label: 'Ancient Greece (750 BC - 146 BC)',
  },
  ...
  'classical period': {
    category: 'Time Period',
    id: 1816,
    label: 'Classical Period (1750 - 1830)',
  },
  ...
  'revolutionary war': {
    category: 'Time Period',
    id: 1818,
    label: 'American Revolutionary War (1775 - 1783)',
  },
  ...
  congo: {
    ...
    id: 1569,
    label: 'Democratic Republic of the Congo / DCR (Zaire)',
  },
  ...
  // ============================================================
  // AUTO-GENERATED TAXONOMY MAPPINGS
  // Generated: 2026-01-06T00:16:44Z
  // Total: 487 new entries from production taxonomy
  // ============================================================

  // === Mood (18 new entries) ===
  abstract: { category: 'Mood', id: 2376, label: 'Abstract' },
  abstract: { category: 'Mood', id: 2377, label: 'Abstract' },
  'angular/disjointed': {
    category: 'Mood',
    id: 2378,
    label: 'Angular or Disjointed',
    contentLabel: 'Angular/Disjointed',
  },
  ...
  atonal: { category: 'Mood', id: 2379, label: 'Atonal' },
  barren: { category: 'Mood', id: 2337, label: 'Barren' },
  blue: { category: 'Mood', id: 2312, label: 'Blue' },
  cold: { category: 'Mood', id: 2338, label: 'Cold' },
  confused: { category: 'Mood', id: 2339, label: 'Confused' },
  disturbing: { category: 'Mood', id: 2335, label: 'Disturbing' },
  fearful: { category: 'Mood', id: 2345, label: 'Fearful' },
  funereal: { category: 'Mood', id: 2314, label: 'Funereal' },
  heavy: { category: 'Mood', id: 2317, label: 'Heavy' },
  jittery: { category: 'Mood', id: 2346, label: 'Jittery' },
  neutral: { category: 'Mood', id: 2382, label: 'Neutral Mood', contentLabel: 'Neutral' },
  'neutral mood': { category: 'Mood', id: 2382, label: 'Neutral Mood', contentLabel: 'Neutral' },
  pathos: { category: 'Mood', id: 2321, label: 'Pathos' },
  'sad/depressing': {
    category: 'Mood',
    id: 2310,
    label: 'Sad & Depressing',
    contentLabel: 'Sad/Depressing',
  },
  'sad & depressing': {
    category: 'Mood',
    id: 2310,
  ...
  simple: { category: 'Mood', id: 2380, label: 'Simple' },
  sparse: { category: 'Mood', id: 2381, label: 'Sparse' },
  // === Character (3 new entries) ===
  groovy: { category: 'Character', id: 2442, label: 'Groovy' },
  'key change': { category: 'Character', id: 3788, label: 'Key Change' },
  'rising/ascending': {
    category: 'Character',
    id: 2452,
    label: 'Rising & Ascending',
    contentLabel: 'Rising/Ascending',
  },
  'rising & ascending': {
    category: 'Character',
    id: 2452,
  ...
  // === Genre (230 new entries) ===
  '2 step': { category: 'Genre', id: 1122, label: '2 Step' },
  'acid jazz': { category: 'Genre', id: 2058, label: 'Acid Jazz' },
  'acid lounge': { category: 'Genre', id: 1123, label: 'Acid Lounge' },
  afrobeat: { category: 'Genre', id: 3414, label: 'Afrobeat' },
  'alternative rock': { category: 'Genre', id: 2132, label: 'Alternative Rock' },
  ambient: { category: 'Genre', id: 1933, label: 'Ambient' },
  'american folk dance': { category: 'Genre', id: 1370, label: 'American Folk Dance' },
  americana: { category: 'Genre', id: 3401, label: 'Americana' },
  aor: { category: 'Genre', id: 1214, label: 'AOR' },
  appalachian: { category: 'Genre', id: 1371, label: 'Appalachian' },
  'asian beats': { category: 'Genre', id: 1175, label: 'Asian Beats' },
  atmospheres: { category: 'Genre', id: 1360, label: 'Atmospheres' },
  'authentic indigenous': { category: 'Genre', id: 1368, label: 'Authentic Indigenous' },
  'authentic indigenous': { category: 'Genre', id: 2177, label: 'Authentic Indigenous' },
  'background/elevator': { category: 'Genre', id: 1215, label: 'Background/Elevator' },
  bebop: { category: 'Genre', id: 2062, label: 'Bebop' },
  bhangra: { category: 'Genre', id: 1176, label: 'Bhangra' },
  'big band': { category: 'Genre', id: 2063, label: 'Big Band' },
  'big beat': { category: 'Genre', id: 1125, label: 'Big Beat' },
  bluegrass: { category: 'Genre', id: 2015, label: 'Bluegrass' },
  blues: { category: 'Genre', id: 1909, label: 'Blues' },
  bollywood: { category: 'Genre', id: 1177, label: 'Bollywood' },
  'boom bap': { category: 'Genre', id: 3803, label: 'Boom Bap' },
  'boom bap': { category: 'Genre', id: 3903, label: 'Boom Bap' },
  breakbeat: { category: 'Genre', id: 1935, label: 'Breakbeat' },
  breakdance: { category: 'Genre', id: 1238, label: 'Breakdance' },
  britpop: { category: 'Genre', id: 2096, label: 'Britpop' },
  buddhist: { category: 'Genre', id: 1297, label: 'Buddhist' },
  'buddhist chanting': { category: 'Genre', id: 1298, label: 'Buddhist Chanting' },
  'buddhist sacred songs': { category: 'Genre', id: 1299, label: 'Buddhist Sacred Songs' },
  'buddhist settings': { category: 'Genre', id: 1300, label: 'Buddhist Settings' },
  'cajun/zydeco': { category: 'Genre', id: 1372, label: 'Cajun/Zydeco' },
  calypso: { category: 'Genre', id: 1377, label: 'Calypso' },
  catholic: { category: 'Genre', id: 1302, label: 'Catholic' },
  chanson: { category: 'Genre', id: 1378, label: 'Chanson' },
  'chemical beats': { category: 'Genre', id: 1127, label: 'Chemical Beats' },
  children: { category: 'Genre', id: 1105, label: 'Children' },
  children: { category: 'Genre', id: 1914, label: 'Children' },
  'chill out/downtempo': {
    category: 'Genre',
    id: 1937,
    label: 'Chill Out & Downtempo',
    contentLabel: 'Chill Out/Downtempo',
  },
  'chill out & downtempo': {
    category: 'Genre',
    id: 1937,
  ...
  christian: { category: 'Genre', id: 1301, label: 'Christian' },
  'christian settings': { category: 'Genre', id: 1306, label: 'Christian Settings' },
  'classic r&b': { category: 'Genre', id: 1229, label: 'Classic R&B' },
  'classic rock': { category: 'Genre', id: 2136, label: 'Classic Rock' },
  'classic soul': { category: 'Genre', id: 1230, label: 'Classic Soul' },
  classical: { category: 'Genre', id: 1919, label: 'Classical' },
  'classical styling': { category: 'Genre', id: 1925, label: 'Classical Styling' },
  'club/electronica': { category: 'Genre', id: 1121, label: 'Club/Electronica' },
  'club/electronica': { category: 'Genre', id: 1129, label: 'Club/Electronica' },
  'club/electronica': {
    category: 'Genre',
    id: 1930,
    label: 'Electronica & EDM',
    contentLabel: 'Club/Electronica',
  },
  'electronica & edm': {
    category: 'Genre',
    id: 1930,
  ...
  'contemporary christian': { category: 'Genre', id: 1303, label: 'Contemporary Christian' },
  'contemporary folk': { category: 'Genre', id: 1170, label: 'Contemporary Folk' },
  'cool jazz': { category: 'Genre', id: 2064, label: 'Cool Jazz' },
  corporate: { category: 'Genre', id: 2001, label: 'Corporate' },
  'corporate pop': { category: 'Genre', id: 2005, label: 'Corporate Pop' },
  country: { category: 'Genre', id: 2013, label: 'Country' },
  'country rock': { category: 'Genre', id: 2018, label: 'Country Rock' },
  'cowboy/western': { category: 'Genre', id: 1373, label: 'Cowboy/Western' },
  'cowboy/western': {
    category: 'Genre',
    id: 2182,
    label: 'Cowboy & Western',
    contentLabel: 'Cowboy/Western',
  },
  'cowboy & western': {
    category: 'Genre',
    id: 2182,
  ...
  dancehall: { category: 'Genre', id: 3404, label: 'Dancehall' },
  dansband: { category: 'Genre', id: 1216, label: 'Dansband' },
  disco: { category: 'Genre', id: 1939, label: 'Disco' },
  drones: { category: 'Genre', id: 1361, label: 'Drones' },
  'drum n bass/jungle': {
    category: 'Genre',
    id: 1940,
    label: 'Drum n Bass & Jungle',
    contentLabel: 'Drum n Bass/Jungle',
  },
  'drum n bass & jungle': {
    category: 'Genre',
    id: 1940,
  ...
  dub: { category: 'Genre', id: 1132, label: 'Dub' },
  dubstep: { category: 'Genre', id: 1942, label: 'Dubstep' },
  'easy listening': { category: 'Genre', id: 1213, label: 'Easy Listening' },
  'easy listening arrangements': {
    category: 'Genre',
    id: 1217,
    label: 'Easy Listening Arrangements',
  },
  edm: { category: 'Genre', id: 3397, label: 'EDM' },
  effects: { category: 'Genre', id: 1362, label: 'Effects' },
  effects: { category: 'Genre', id: 2171, label: 'Effects' },
  electro: { category: 'Genre', id: 1943, label: 'Electro' },
  'electro pop': { category: 'Genre', id: 2098, label: 'Electro Pop' },
  electroclash: { category: 'Genre', id: 1135, label: 'Electroclash' },
  electronica: { category: 'Genre', id: 1945, label: 'Electronica' },
  'ethnic dance/pop style': { category: 'Genre', id: 1174, label: 'Ethnic Dance/Pop Style' },
  'ethnic dance/pop style': {
    category: 'Genre',
    id: 1983,
    label: 'Ethnic Pop Styles',
    contentLabel: 'Ethnic Dance/Pop Style',
  },
  'ethnic pop styles': {
    category: 'Genre',
    id: 1983,
  ...
  'euro beat': { category: 'Genre', id: 1137, label: 'Euro Beat' },
  'euro pop': { category: 'Genre', id: 1138, label: 'Euro Pop' },
  exotica: { category: 'Genre', id: 1178, label: 'Exotica' },
  fado: { category: 'Genre', id: 1379, label: 'Fado' },
  'film score/orchestral': {
    category: 'Genre',
    id: 2031,
    label: 'Score & Instrumental Background',
    contentLabel: 'Film Score/Orchestral',
  },
  'score & instrumental background': {
    category: 'Genre',
    id: 2031,
    label: 'Score & Instrumental Background',
    contentLabel: 'Film Score/Orchestral',
  },
  'film score/trailer': { category: 'Genre', id: 2033, label: 'Film Score/Trailer' },
  'folk rock': { category: 'Genre', id: 1171, label: 'Folk Rock' },
  funk: { category: 'Genre', id: 2041, label: 'Funk' },
  'funk/soul/r&b': { category: 'Genre', id: 1228, label: 'Funk/Soul/R&B' },
  'funk/soul/r&b': {
    category: 'Genre',
    id: 2037,
    label: 'Funk, Soul & R&B',
    contentLabel: 'Funk/Soul/R&B',
  },
  'funk, soul & r&b': {
    category: 'Genre',
    id: 2037,
  ...
  fusion: { category: 'Genre', id: 2068, label: 'Jazz Fusion', contentLabel: 'Fusion' },
  'jazz fusion': { category: 'Genre', id: 2068, label: 'Jazz Fusion', contentLabel: 'Fusion' },
  'future bass': { category: 'Genre', id: 3398, label: 'Future Bass' },
  gabba: { category: 'Genre', id: 1139, label: 'Gabba' },
  garage: { category: 'Genre', id: 1140, label: 'Garage' },
  'garage rock': { category: 'Genre', id: 2141, label: 'Garage Rock' },
  global: { category: 'Genre', id: 2000, label: 'Global' },
  'go-go': { category: 'Genre', id: 3802, label: 'Go-go' },
  'go-go': { category: 'Genre', id: 3902, label: 'Go-go' },
  'goa trance': { category: 'Genre', id: 1141, label: 'Goa Trance' },
  grooves: { category: 'Genre', id: 1142, label: 'Grooves' },
  grunge: { category: 'Genre', id: 2144, label: 'Grunge' },
  gypsy: { category: 'Genre', id: 1380, label: 'Gypsy' },
  'hard rock': { category: 'Genre', id: 2145, label: 'Hard Rock' },
  'hardcore electonica': { category: 'Genre', id: 1143, label: 'Hardcore Electonica' },
  hawaiian: { category: 'Genre', id: 1374, label: 'Hawaiian' },
  'heavy metal': { category: 'Genre', id: 2147, label: 'Heavy Metal' },
  hindu: { category: 'Genre', id: 1307, label: 'Hindu' },
  'hindu sacred songs': { category: 'Genre', id: 1308, label: 'Hindu Sacred Songs' },
  'hindu settings': { category: 'Genre', id: 1309, label: 'Hindu Settings' },
  'hip hop': { category: 'Genre', id: 2048, label: 'Hip Hop' },
  'hip hop/urban': { category: 'Genre', id: 1237, label: 'Hip Hop/Urban' },
  'hip hop/urban': { category: 'Genre', id: 2046, label: 'Hip Hop', contentLabel: 'Hip Hop/Urban' },
  'hip hop': { category: 'Genre', id: 2046, label: 'Hip Hop', contentLabel: 'Hip Hop/Urban' },
  house: { category: 'Genre', id: 1953, label: 'House' },
  indie: { category: 'Genre', id: 2148, label: 'Indie' },
  'indie pop': { category: 'Genre', id: 3409, label: 'Indie Pop' },
  islamic: { category: 'Genre', id: 1310, label: 'Islamic' },
  'islamic sacred songs': { category: 'Genre', id: 1312, label: 'Islamic Sacred Songs' },
  'islamic settings': { category: 'Genre', id: 1313, label: 'Islamic Settings' },
  'jawaiian reggae': { category: 'Genre', id: 1179, label: 'Jawaiian Reggae' },
  jazz: { category: 'Genre', id: 2057, label: 'Jazz' },
  jazz: { category: 'Genre', id: 2071, label: 'Jazz' },
  jewish: { category: 'Genre', id: 1314, label: 'Jewish' },
  'jewish cantorial': { category: 'Genre', id: 1315, label: 'Jewish Cantorial' },
  'jewish sacred songs': { category: 'Genre', id: 1316, label: 'Jewish Sacred Songs' },
  'jewish settings': { category: 'Genre', id: 1317, label: 'Jewish Settings' },
  jungle: { category: 'Genre', id: 1157, label: 'Jungle' },
  'kitsch/cheesy': { category: 'Genre', id: 1275, label: 'Kitsch/Cheesy' },
  'kitsch/cheesy': {
    category: 'Genre',
    id: 2084,
    label: 'Kitsch & Cheesy',
    contentLabel: 'Kitsch/Cheesy',
  },
  'kitsch & cheesy': {
    category: 'Genre',
    id: 2084,
  ...
  'kitsch/retro': { category: 'Genre', id: 1274, label: 'Kitsch/Retro' },
  'kitsch/retro': {
    category: 'Genre',
    id: 2083,
    label: 'Kitsch & Retro',
    contentLabel: 'Kitsch/Retro',
  },
  'kitsch & retro': {
    category: 'Genre',
    id: 2083,
  ...
  klezmer: { category: 'Genre', id: 1381, label: 'Klezmer' },
  latin: { category: 'Genre', id: 2086, label: 'Latin Music', contentLabel: 'Latin' },
  'latin music': { category: 'Genre', id: 2086, label: 'Latin Music', contentLabel: 'Latin' },
  'latin folk music': { category: 'Genre', id: 1382, label: 'Latin Folk Music' },
  'latin jazz': { category: 'Genre', id: 2075, label: 'Latin Jazz' },
  leftfield: { category: 'Genre', id: 1158, label: 'Leftfield' },
  'liquid funk': { category: 'Genre', id: 1233, label: 'Liquid Funk' },
  'lo fi': { category: 'Genre', id: 1159, label: 'Lo Fi' },
  loungecore: { category: 'Genre', id: 1160, label: 'Loungecore' },
  lullaby: { category: 'Genre', id: 1106, label: 'Lullaby' },
  lullaby: { category: 'Genre', id: 1915, label: 'Lullaby' },
  luxury: { category: 'Genre', id: 2006, label: 'Luxury' },
  'marches/military band': { category: 'Genre', id: 1285, label: 'Marches/Military Band' },
  'marches/military band': {
    category: 'Genre',
    id: 2094,
    label: 'Marches & Military Band',
    contentLabel: 'Marches/Military Band',
  },
  'marches & military band': {
    category: 'Genre',
    id: 2094,
  ...
  mariachi: { category: 'Genre', id: 1383, label: 'Mariachi' },
  'middle of the road': { category: 'Genre', id: 1219, label: 'Middle Of The Road' },
  motivational: { category: 'Genre', id: 2007, label: 'Motivational' },
  motown: { category: 'Genre', id: 2043, label: 'Motown' },
  'music elements': { category: 'Genre', id: 1363, label: 'Music Elements' },
  'music elements': { category: 'Genre', id: 2172, label: 'Music Elements' },
  'muslim call to prayer': { category: 'Genre', id: 1311, label: 'Muslim Call To Prayer' },
  'national folk dance': { category: 'Genre', id: 1384, label: 'National Folk Dance' },
  'national folk dance': { category: 'Genre', id: 2193, label: 'National Folk Dance' },
  'national folk music': { category: 'Genre', id: 1385, label: 'National Folk Music' },
  'national folk music': { category: 'Genre', id: 2194, label: 'National Folk Music' },
  'native american': { category: 'Genre', id: 1375, label: 'Native American' },
  'new acoustic': { category: 'Genre', id: 1173, label: 'New Acoustic' },
  'new jack swing': { category: 'Genre', id: 3383, label: 'New Jack Swing' },
  'new wave': { category: 'Genre', id: 2152, label: 'New Wave' },
  'northern soul': { category: 'Genre', id: 1235, label: 'Northern Soul' },
  'nu school breaks': { category: 'Genre', id: 1161, label: 'Nu School Breaks' },
  'nursery rhyme': { category: 'Genre', id: 1107, label: 'Nursery Rhyme' },
  'nursery rhyme': { category: 'Genre', id: 1916, label: 'Nursery Rhyme' },
  'orchestral hybrid': { category: 'Genre', id: 2036, label: 'Orchestral Hybrid' },
  pop: { category: 'Genre', id: 2095, label: 'Pop' },
  pop: { category: 'Genre', id: 2101, label: 'Pop' },
  'pop rock': { category: 'Genre', id: 3410, label: 'Pop Rock' },
  'post punk': { category: 'Genre', id: 3411, label: 'Post Punk' },
  'power/energy': {
    category: 'Genre',
    id: 2008,
    label: 'Power & Energy',
    contentLabel: 'Power/Energy',
  },
  'power & energy': {
    category: 'Genre',
    id: 2008,
  ...
  'pre school': { category: 'Genre', id: 1108, label: 'Pre School' },
  'pre school': { category: 'Genre', id: 1917, label: 'Pre School' },
  prestige: { category: 'Genre', id: 2009, label: 'Prestige' },
  'progressive rock': { category: 'Genre', id: 2155, label: 'Progressive Rock' },
  protestant: { category: 'Genre', id: 1304, label: 'Protestant' },
  psychedelic: { category: 'Genre', id: 2156, label: 'Psychedelic' },
  punk: { category: 'Genre', id: 2157, label: 'Punk' },
  ragga: { category: 'Genre', id: 1180, label: 'Ragga' },
  rai: { category: 'Genre', id: 1181, label: 'Rai' },
  rap: { category: 'Genre', id: 2056, label: 'Rap' },
  rave: { category: 'Genre', id: 1162, label: 'Rave' },
  reggae: { category: 'Genre', id: 1991, label: 'Reggae' },
  religious: { category: 'Genre', id: 1296, label: 'Religious' },
  religious: { category: 'Genre', id: 2105, label: 'Religious' },
  remixes: { category: 'Genre', id: 1163, label: 'Remixes' },
  'retro electronica': { category: 'Genre', id: 1164, label: 'Retro Electronica' },
  'retro electronica': { category: 'Genre', id: 1973, label: 'Retro Electronica' },
  'retro kitsch': { category: 'Genre', id: 1276, label: 'Retro Kitsch' },
  'retro kitsch': { category: 'Genre', id: 2085, label: 'Retro Kitsch' },
  'reveal/launch': {
    category: 'Genre',
    id: 2010,
    label: 'Reveal & Launch',
    contentLabel: 'Reveal/Launch',
  },
  'reveal & launch': {
    category: 'Genre',
    id: 2010,
  ...
  'rhythm & blues': { category: 'Genre', id: 1913, label: 'Rhythm & Blues' },
  rock: { category: 'Genre', id: 2131, label: 'Rock' },
  rock: { category: 'Genre', id: 2160, label: 'Rock' },
  'rock techno': { category: 'Genre', id: 1165, label: 'Rock Techno' },
  rocksteady: { category: 'Genre', id: 3804, label: 'Rocksteady' },
  rocksteady: { category: 'Genre', id: 3904, label: 'Rocksteady' },
  schlager: { category: 'Genre', id: 1221, label: 'Schlager' },
  'science/technology': {
    category: 'Genre',
    id: 2011,
    label: 'Science & Technology',
    contentLabel: 'Science/Technology',
  },
  'science & technology': {
    category: 'Genre',
    id: 2011,
  ...
  'sea shanty': { category: 'Genre', id: 1386, label: 'Sea Shanty' },
  shamanistic: { category: 'Genre', id: 1318, label: 'Shamanistic' },
  'shamanistic chanting': { category: 'Genre', id: 1319, label: 'Shamanistic Chanting' },
  'shamanistic sacred songs': { category: 'Genre', id: 1320, label: 'Shamanistic Sacred Songs' },
  'shamanistic settings': { category: 'Genre', id: 1321, label: 'Shamanistic Settings' },
  ska: { category: 'Genre', id: 1992, label: 'Ska' },
  'smooth jazz': { category: 'Genre', id: 2079, label: 'Smooth Jazz' },
  'sound design': { category: 'Genre', id: 1364, label: 'Sound Design' },
  'sound design': { category: 'Genre', id: 2173, label: 'Sound Design' },
  'sound elements/atmospheres': {
    category: 'Genre',
    id: 1359,
    label: 'Sound Elements/Atmospheres',
  },
  'sound elements/atmospheres': {
    category: 'Genre',
    id: 2168,
    label: 'Sound Elements & Atmospheres',
    contentLabel: 'Sound Elements/Atmospheres',
  },
  'sound elements & atmospheres': {
    category: 'Genre',
    id: 2168,
  ...
  'southern rock': { category: 'Genre', id: 2164, label: 'Southern Rock' },
  storytelling: { category: 'Genre', id: 1109, label: 'Storytelling' },
  storytelling: { category: 'Genre', id: 1918, label: 'Storytelling' },
  swing: { category: 'Genre', id: 2081, label: 'Swing' },
  'synth pop': { category: 'Genre', id: 2103, label: 'Synth Pop' },
  synthwave: { category: 'Genre', id: 3400, label: 'Synthwave' },
  techno: { category: 'Genre', id: 1975, label: 'Techno' },
  township: { category: 'Genre', id: 1184, label: 'Township' },
  'traditional american folk/ethnic': {
    category: 'Genre',
    id: 1369,
    label: 'Traditional American Folk/Ethnic',
  },
  'traditional american folk/ethnic': {
    category: 'Genre',
    id: 2178,
    label: 'Traditional American Folk & Ethnic',
    contentLabel: 'Traditional American Folk/Ethnic',
  },
  'traditional american folk & ethnic': {
    category: 'Genre',
    id: 2178,
  ...
  'traditional dance styles': { category: 'Genre', id: 1365, label: 'Traditional Dance Styles' },
  'traditional dance styles': { category: 'Genre', id: 2174, label: 'Traditional Dance Styles' },
  'traditional ethnic folk': { category: 'Genre', id: 1367, label: 'Traditional Ethnic Folk' },
  'traditional ethnic folk': { category: 'Genre', id: 2176, label: 'Traditional Ethnic Folk' },
  'traditional latin dance styles': {
    category: 'Genre',
    id: 1366,
    label: 'Traditional Latin Dance Styles',
  },
  'traditional latin dance styles': {
    category: 'Genre',
    id: 2175,
  ...
  'traditional national/ethnic': {
    category: 'Genre',
    id: 1376,
    label: 'Traditional National/Ethnic',
  },
  'traditional national/ethnic': {
    category: 'Genre',
    id: 2185,
    label: 'Traditional National & Ethnic',
    contentLabel: 'Traditional National/Ethnic',
  },
  'traditional national & ethnic': {
    category: 'Genre',
    id: 2185,
  ...
  'training/information': {
    ...
    contentLabel: 'Training/Information',
  },
  'training & information': {
    category: 'Genre',
    id: 2012,
  ...
  trance: { category: 'Genre', id: 1976, label: 'Trance' },
  trap: { category: 'Genre', id: 3408, label: 'Trap' },
  'trip hop': { category: 'Genre', id: 1977, label: 'Trip Hop' },
  'west coast r&b': { category: 'Genre', id: 1236, label: 'West Coast R&B' },
  'west coast r&b': { category: 'Genre', id: 2045, label: 'West Coast R&B' },
  'western/cowboy': {
    category: 'Genre',
    id: 2020,
    label: 'Western & Cowboy',
    contentLabel: 'Western/Cowboy',
  },
  'western & cowboy': {
    category: 'Genre',
    id: 2020,
  ...
  'world beat/ethnic stylings': {
    category: 'Genre',
    id: 1994,
    label: 'World Beat Stylings',
    contentLabel: 'World Beat/Ethnic Stylings',
  },
  'world beat stylings': {
    category: 'Genre',
    id: 1994,
  ...
  'zombie hip hop': { category: 'Genre', id: 1169, label: 'Zombie Hip Hop' },
  // === Music For (102 new entries) ===
  'activities & settings': { category: 'Music For', id: 2557, label: 'Activities & Settings' },
  'adult entertainment/porn': {
    category: 'Music For',
    id: 2605,
    label: 'Adult Entertainment & Porn',
    contentLabel: 'Adult Entertainment/Porn',
  },
  'adult entertainment & porn': {
    category: 'Music For',
    id: 2605,
  ...
  'american civil war': { category: 'Music For', id: 2595, label: 'American Civil War' },
  'american revolutionary war': {
    category: 'Music For',
    id: 2594,
    label: 'American Revolutionary War',
  },
  ancient: { category: 'Music For', id: 2593, label: 'Ancient' },
  'art house': { category: 'Music For', id: 2607, label: 'Art House' },
  'arts/antiques': {
    category: 'Music For',
    id: 2654,
    label: 'Arts & Antiques',
    contentLabel: 'Arts/Antiques',
  },
  'arts & antiques': {
    category: 'Music For',
    id: 2654,
  ...
  automation: { category: 'Music For', id: 2729, label: 'Automation' },
  autumn: { category: 'Music For', id: 2726, label: 'Autumn' },
  'b movie': { category: 'Music For', id: 2608, label: 'B Movie' },
  'back end': { category: 'Music For', id: 2609, label: 'Back End' },
  blaxploitation: { category: 'Music For', id: 2610, label: 'Blaxploitation' },
  bollywood: { category: 'Music For', id: 2611, label: 'Bollywood' },
  boxing: { category: 'Music For', id: 2682, label: 'Boxing' },
  cabaret: { category: 'Music For', id: 2692, label: 'Cabaret' },
  'ceremonial/royal ceremony': {
    category: 'Music For',
    id: 2740,
    label: 'Ceremony',
    contentLabel: 'Ceremonial/Royal Ceremony',
  },
  ceremony: {
    category: 'Music For',
    id: 2740,
  ...
  'children/pre school': {
    category: 'Music For',
    id: 2566,
    label: 'Children & Pre School',
    contentLabel: 'Children/Pre School',
  },
  'children & pre school': {
    category: 'Music For',
    id: 2566,
  ...
  'children/storytelling': {
    category: 'Music For',
    id: 2612,
    label: 'Children & Storytelling',
    contentLabel: 'Children/Storytelling',
  },
  'children & storytelling': {
    category: 'Music For',
    id: 2612,
  ...
  'chinese new year': { category: 'Music For', id: 3535, label: 'Chinese New Year' },
  'cinco de mayo': {
    category: 'Music For',
    id: 3538,
    label: 'Cinco de Mayo',
    contentLabel: 'Cinco De Mayo',
  },
  'cold/barren': {
    category: 'Music For',
    id: 2716,
    label: 'Cold & Barren',
    contentLabel: 'Cold/Barren',
  },
  'cold & barren': {
    category: 'Music For',
    id: 2716,
  ...
  dawn: { category: 'Music For', id: 2721, label: 'Dawn' },
  'design beds': { category: 'Music For', id: 2730, label: 'Design Beds' },
  epic: { category: 'Music For', id: 2623, label: 'Epic' },
  'equestrian events': { category: 'Music For', id: 2683, label: 'Equestrian Events' },
  events: { category: 'Music For', id: 2737, label: 'Events' },
  family: { category: 'Music For', id: 2625, label: 'Family' },
  'family drama': { category: 'Music For', id: 2676, label: 'Family Drama' },
  'fathers day': { category: 'Music For', id: 2754, label: 'Fathers Day' },
  'food/leisure/home/garden': {
    category: 'Music For',
    id: 2656,
    label: 'Food, Leisure, Home & Garden',
    contentLabel: 'Food/Leisure/Home/Garden',
  },
  'food, leisure, home & garden': {
    category: 'Music For',
    id: 2656,
  ...
  'french cinema': { category: 'Music For', id: 2628, label: 'French Cinema' },
  'general celebration': { category: 'Music For', id: 2738, label: 'General Celebration' },
  'general war/battle scenes': {
    category: 'Music For',
    id: 2591,
    label: 'General War & Battle Scenes',
    contentLabel: 'General War/Battle Scenes',
  },
  'general war & battle scenes': {
    category: 'Music For',
    id: 2591,
  ...
  graduation: { category: 'Music For', id: 3777, label: 'Graduation' },
  hanukkah: { category: 'Music For', id: 2757, label: 'Hanukkah' },
  'health/wellness': {
    category: 'Music For',
    id: 2657,
    label: 'Health & Wellness',
    contentLabel: 'Health/Wellness',
  },
  'health & wellness': {
    category: 'Music For',
    id: 2657,
  ...
  'heavenly/celestial': {
    category: 'Music For',
    id: 2713,
    label: 'Heavenly & Celestial',
    contentLabel: 'Heavenly/Celestial',
  },
  'heavenly & celestial': {
    category: 'Music For',
    id: 2713,
  ...
  'heavy industry': { category: 'Music For', id: 2731, label: 'Heavy Industry' },
  'hi tech': { category: 'Music For', id: 2732, label: 'Hi Tech' },
  historical: { category: 'Music For', id: 2592, label: 'Historical' },
  'holiday/seasonal': { category: 'Music For', id: 3158, label: 'Holiday/Seasonal' },
  holidays: { category: 'Music For', id: 2748, label: 'Holidays' },
  'indie films': { category: 'Music For', id: 2630, label: 'Indie Films' },
  'italian cinema': { category: 'Music For', id: 2631, label: 'Italian Cinema' },
  'jewish holidays': { category: 'Music For', id: 3537, label: 'Jewish Holidays' },
  juneteenth: { category: 'Music For', id: 3539, label: 'Juneteenth' },
  'landscapes, panorama': {
    category: 'Music For',
    id: 2706,
    label: 'Panoramic Landscapes',
    contentLabel: 'Landscapes, Panorama',
  },
  ...
  'leisure/lifestyle': {
    ...
    contentLabel: 'Leisure/Lifestyle',
  },
  'leisure & lifestyle': {
    category: 'Music For',
    id: 2653,
  ...
  'live entertainment/theater': {
    category: 'Music For',
    id: 2691,
    label: 'Live Entertainment & Theater',
    contentLabel: 'Live Entertainment/Theater',
  },
  'live entertainment & theater': {
    category: 'Music For',
    id: 2691,
  ...
  'mardi gras': {
    category: 'Music For',
    id: 3536,
    label: 'Mardi Gras (Fat Tuesday)',
    contentLabel: 'Mardi Gras',
  },
  ...
  'martial arts': { category: 'Music For', id: 2632, label: 'Martial Arts' },
  'martin luther king jr. day': {
    category: 'Music For',
    id: 3534,
    label: 'Martin Luther King Jr. Day',
  },
  'medical drama': { category: 'Music For', id: 2677, label: 'Medical Drama' },
  'military marches/military band': {
    category: 'Music For',
    id: 2599,
    label: 'Military Marches & Military Band',
    contentLabel: 'Military Marches/Military Band',
  },
  'military marches & military band': {
    category: 'Music For',
    id: 2599,
  ...
  'modern warfare': { category: 'Music For', id: 2598, label: 'Modern Warfare' },
  'mothers day': { category: 'Music For', id: 2753, label: 'Mothers Day' },
  movies: { category: 'Music For', id: 2602, label: 'Movies' },
  'movies, modern': {
    category: 'Music For',
    id: 2633,
    label: 'Modern Movies',
    contentLabel: 'Movies, Modern',
  },
  'modern movies': {
    category: 'Music For',
    id: 2633,
  ...
  'naval battle': { category: 'Music For', id: 2600, label: 'Naval Battle' },
  nighttime: { category: 'Music For', id: 2723, label: 'Nighttime' },
  'non usa holidays': { category: 'Music For', id: 2759, label: 'Non USA Holidays' },
  'non western ceremonies': { category: 'Music For', id: 2742, label: 'Non Western Ceremonies' },
  'patriotic holidays (usa)': {
    category: 'Music For',
    id: 2758,
    label: 'USA Patriotic Holidays',
    contentLabel: 'Patriotic Holidays (USA)',
  },
  ...
  'period/historical/costume drama': {
    category: 'Music For',
    id: 2635,
    label: 'Period, Historical & Costume Drama',
    contentLabel: 'Period/Historical/Costume Drama',
  },
  'period, historical & costume drama': {
    category: 'Music For',
    id: 2635,
  ...
  'play on/play off': {
    category: 'Music For',
    id: 2694,
    label: 'Play On & Play Off',
    contentLabel: 'Play On/Play Off',
  },
  'play on & play off': {
    category: 'Music For',
    id: 2694,
  ...
  podcasts: { category: 'Music For', id: 4002, label: 'Podcasts' },
  'police/legal/courtroom drama': {
    category: 'Music For',
    id: 2678,
    label: 'Police, Legal & Courtroom Drama',
    contentLabel: 'Police/Legal/Courtroom Drama',
  },
  'police, legal & courtroom drama': {
    category: 'Music For',
    id: 2678,
  ...
  rain: { category: 'Music For', id: 2717, label: 'Rain' },
  'religion & religious settings': {
    category: 'Music For',
    id: 2735,
    label: 'Religion & Religious Settings',
  },
  'road movie': { category: 'Music For', id: 2636, label: 'Road Movie' },
  'science/technology/industry': {
    category: 'Music For',
    id: 2728,
    label: 'Corporate Science & Technology',
    contentLabel: 'Science/Technology/Industry',
  },
  'corporate science & technology': {
    category: 'Music For',
    id: 2728,
    label: 'Corporate Science & Technology',
    contentLabel: 'Science/Technology/Industry',
  },
  'scientific atmospheres': { category: 'Music For', id: 2734, label: 'Scientific Atmospheres' },
  'seafaring/pirates': {
    category: 'Music For',
    id: 2583,
    label: 'Seafaring & Pirates',
    contentLabel: 'Seafaring/Pirates',
  },
  'seafaring & pirates': {
    category: 'Music For',
    id: 2583,
  ...
  showbiz: { category: 'Music For', id: 2584, label: 'Showbiz' },
  'silent movie/melodrama': {
    category: 'Music For',
    id: 2640,
    label: 'Silent Movie & Melodrama',
    contentLabel: 'Silent Movie/Melodrama',
  },
  'silent movie & melodrama': {
    category: 'Music For',
    id: 2640,
  ...
  'snow/ice': { category: 'Music For', id: 2705, label: 'Snow & Ice', contentLabel: 'Snow/Ice' },
  'snow & ice': { category: 'Music For', id: 2705, label: 'Snow & Ice', contentLabel: 'Snow/Ice' },
  'spaghetti western': { category: 'Music For', id: 2641, label: 'Spaghetti Western' },
  'special occasions': { category: 'Music For', id: 2736, label: 'Special Occasions' },
  sports: { category: 'Music For', id: 2679, label: 'Sports' },
  spring: { category: 'Music For', id: 2724, label: 'Spring' },
  "st. patrick's day": { category: 'Music For', id: 2751, label: "St. Patrick's Day" },
  'storms/thunder/wind/hurricanes': {
    category: 'Music For',
    id: 2718,
    label: 'Storms, Thunder, Wind & Hurricanes',
    contentLabel: 'Storms/Thunder/Wind/Hurricanes',
  },
  'storms, thunder, wind & hurricanes': {
    category: 'Music For',
    id: 2718,
  ...
  'striptease/burlesque': {
    category: 'Music For',
    id: 2587,
    label: 'Striptease & Burlesque',
    contentLabel: 'Striptease/Burlesque',
  },
  'striptease & burlesque': {
    category: 'Music For',
    id: 2587,
  ...
  summer: { category: 'Music For', id: 2725, label: 'Summer' },
  'sun/heat': { category: 'Music For', id: 2719, label: 'Sun & Heat', contentLabel: 'Sun/Heat' },
  'sun & heat': { category: 'Music For', id: 2719, label: 'Sun & Heat', contentLabel: 'Sun/Heat' },
  'sun/tropical/seaside': {
    category: 'Music For',
    id: 2703,
    label: 'Sun, Tropical & Seaside',
    contentLabel: 'Sun/Tropical/Seaside',
  },
  'sun, tropical & seaside': {
    category: 'Music For',
    id: 2703,
  ...
  sunset: { category: 'Music For', id: 2722, label: 'Sunset' },
  surfing: { category: 'Music For', id: 2690, label: 'Surfing' },
  'traditional hunting': { category: 'Music For', id: 2588, label: 'Traditional Hunting' },
  'trailer back ends': { category: 'Music For', id: 3778, label: 'Trailer Back Ends' },
  'trailer intros': { category: 'Music For', id: 3779, label: 'Trailer Intros' },
  trailers: { category: 'Music For', id: 2645, label: 'Trailer Track', contentLabel: 'Trailers' },
  'trailer track': {
    category: 'Music For',
    id: 2645,
    label: 'Trailer Track',
    contentLabel: 'Trailers',
  },
  'tv drama': { category: 'Music For', id: 2675, label: 'TV Drama' },
  'tv/radio program formats': {
    category: 'Music For',
    id: 2646,
    label: 'TV & Radio Program Formats',
    contentLabel: 'TV/Radio Program Formats',
  },
  'tv & radio program formats': {
    category: 'Music For',
    id: 2646,
  ...
  'tv/radio themes': {
    category: 'Music For',
    id: 2674,
    label: 'TV & Radio Themes',
    contentLabel: 'TV/Radio Themes',
  },
  'tv & radio themes': {
    category: 'Music For',
    id: 2674,
  ...
  'urban drama': { category: 'Music For', id: 2642, label: 'Urban Drama' },
  'vaudeville/music hall': {
    category: 'Music For',
    id: 2695,
    label: 'Vaudeville & Music Hall',
    contentLabel: 'Vaudeville/Music Hall',
  },
  'vaudeville & music hall': {
    category: 'Music For',
    id: 2695,
  ...
  'vocal jingles': { category: 'Music For', id: 2652, label: 'Vocal Jingles' },
  'war/military': {
    category: 'Music For',
    id: 2590,
    label: 'War & Military',
    contentLabel: 'War/Military',
  },
  'war & military': {
    category: 'Music For',
    id: 2590,
  ...
  winter: { category: 'Music For', id: 2727, label: 'Winter' },
  'world war 1': { category: 'Music For', id: 2596, label: 'World War 1' },
  'world war 2': { category: 'Music For', id: 2597, label: 'World War 2' },
  // === Instruments (134 new entries) ===
  'african flute': { category: 'Instruments', id: 2873, label: 'African Flute' },
  'african percussion': { category: 'Instruments', id: 2778, label: 'African Percussion' },
  'alpine horn': { category: 'Instruments', id: 2772, label: 'Alpine Horn' },
  balafon: { category: 'Instruments', id: 2779, label: 'Balafon' },
  'balinese flute': { category: 'Instruments', id: 2874, label: 'Balinese Flute' },
  'bamboo rattle': { category: 'Instruments', id: 2780, label: 'Bamboo Rattle' },
  banhu: { category: 'Instruments', id: 2816, label: 'Banhu' },
  bansuri: { category: 'Instruments', id: 2875, label: 'Bansuri' },
  'barro flute': { category: 'Instruments', id: 2876, label: 'Barro Flute' },
  'bass clarinet': { category: 'Instruments', id: 3017, label: 'Bass Clarinet' },
  bawu: { category: 'Instruments', id: 3798, label: 'Bawu' },
  'bell tree': {
    category: 'Instruments',
    id: 2781,
    label: 'Bell Tree (Non-western)',
    contentLabel: 'Bell Tree',
  },
  'bell tree (non-western)': {
    category: 'Instruments',
    id: 2781,
    label: 'Bell Tree (Non-western)',
    contentLabel: 'Bell Tree',
  ...
  berimbau: { category: 'Instruments', id: 2817, label: 'Berimbau' },
  birbini: { category: 'Instruments', id: 2907, label: 'Birbini' },
  'burmese harp': { category: 'Instruments', id: 2819, label: 'Burmese Harp' },
  charango: { category: 'Instruments', id: 2820, label: 'Charango' },
  cheng: { category: 'Instruments', id: 2908, label: 'Cheng' },
  clapsticks: { category: 'Instruments', id: 2785, label: 'Clapsticks' },
  'conch shell': { category: 'Instruments', id: 2969, label: 'Conch Shell' },
  cornu: { category: 'Instruments', id: 2773, label: 'Cornu' },
  cuica: { category: 'Instruments', id: 2787, label: 'Cuica' },
  cura: { category: 'Instruments', id: 2821, label: 'Cura' },
  'cymbalom/cimbalom': {
    category: 'Instruments',
    id: 2822,
    label: 'Cymbalom or Cimbalom',
    contentLabel: 'Cymbalom/Cimbalom',
  },
  'cymbalom or cimbalom': {
    category: 'Instruments',
    id: 2822,
    label: 'Cymbalom or Cimbalom',
    contentLabel: 'Cymbalom/Cimbalom',
  ...
  'darbuka/derbouka': {
    category: 'Instruments',
    id: 2788,
    label: 'Darbuka or Derbouka',
    contentLabel: 'Darbuka/Derbouka',
  },
  'darbuka or derbouka': {
    category: 'Instruments',
    id: 2788,
  ...
  'diatonic accordion': { category: 'Instruments', id: 2775, label: 'Diatonic Accordion' },
  dilruba: { category: 'Instruments', id: 2823, label: 'Dilruba' },
  dizi: { category: 'Instruments', id: 2877, label: 'Dizi' },
  domra: { category: 'Instruments', id: 2824, label: 'Domra' },
  'doudouk/duduk': {
    category: 'Instruments',
    id: 2909,
    label: 'Doudouk or Duduk',
    contentLabel: 'Doudouk/Duduk',
  },
  'doudouk or duduk': {
    category: 'Instruments',
    id: 2909,
  ...
  'duck call': { category: 'Instruments', id: 2970, label: 'Duck Call' },
  'electric guitar, southern africa': {
    category: 'Instruments',
    id: 2825,
    label: 'Electric Guitar - Southern Africa',
    contentLabel: 'Electric Guitar, Southern Africa',
  },
  'electric guitar - southern africa': {
    category: 'Instruments',
    id: 2825,
  ...
  'electric guitar, western africa/central africa': {
    category: 'Instruments',
    id: 2826,
    label: 'Electric Guitar - Western & Central Africa',
    contentLabel: 'Electric Guitar, Western Africa/Central Africa',
  },
  'electric guitar - western & central africa': {
    category: 'Instruments',
    id: 2826,
    label: 'Electric Guitar - Western & Central Africa',
    contentLabel: 'Electric Guitar, Western Africa/Central Africa',
  },
  'enanga harp': { category: 'Instruments', id: 2827, label: 'Enanga Harp' },
  esraj: { category: 'Instruments', id: 2829, label: 'Esraj' },
  'ethnic, historical, non western': {
    category: 'Instruments',
    id: 2770,
    label: 'Ethnic, Historical, Non Western',
  },
  'french pipes': { category: 'Instruments', id: 2879, label: 'French Pipes' },
  gaida: { category: 'Instruments', id: 2899, label: 'Gaida' },
  gaohu: { category: 'Instruments', id: 2831, label: 'Gaohu' },
  gasba: { category: 'Instruments', id: 2880, label: 'Gasba' },
  gemshorn: { category: 'Instruments', id: 2881, label: 'Gemshorn' },
  'ghuzhen/guzheng/zheng': {
    category: 'Instruments',
    id: 2832,
    label: 'Ghuzhen, Guzheng or Zheng',
    contentLabel: 'Ghuzhen/Guzheng/Zheng',
  },
  'ghuzhen, guzheng or zheng': {
    category: 'Instruments',
    id: 2832,
    label: 'Ghuzhen, Guzheng or Zheng',
    contentLabel: 'Ghuzhen/Guzheng/Zheng',
  },
  'glass harmonica': { category: 'Instruments', id: 2971, label: 'Glass Harmonica' },
  guanzi: { category: 'Instruments', id: 2910, label: 'Guanzi' },
  'guitar, hawaiian': {
    category: 'Instruments',
    id: 2833,
    label: 'Hawaiian Guitar',
    contentLabel: 'Guitar, Hawaiian',
  },
  'hawaiian guitar': {
    category: 'Instruments',
    id: 2833,
  ...
  guitarron: { category: 'Instruments', id: 2834, label: 'Guitarron' },
  guqin: { category: 'Instruments', id: 2835, label: 'Guqin' },
  'gypsy violin': { category: 'Instruments', id: 2836, label: 'Gypsy Violin' },
  hajouj: { category: 'Instruments', id: 2837, label: 'Hajouj' },
  hulusi: { category: 'Instruments', id: 3799, label: 'Hulusi' },
  'ice cream van': { category: 'Instruments', id: 2972, label: 'Ice Cream Van' },
  'irish flute': { category: 'Instruments', id: 2882, label: 'Irish Flute' },
  'jakhay/jakay': {
    category: 'Instruments',
    id: 2839,
    label: 'Jakhay or Jakay',
    contentLabel: 'Jakhay/Jakay',
  },
  'jakhay or jakay': {
    category: 'Instruments',
    id: 2839,
  ...
  jinghu: { category: 'Instruments', id: 3254, label: 'Jinghu' },
  'junk percussion/found objects': {
    category: 'Instruments',
    id: 2974,
    label: 'Junk Percussion & Found Objects',
    contentLabel: 'Junk Percussion/Found Objects',
  },
  'junk percussion & found objects': {
    category: 'Instruments',
    id: 2974,
  ...
  kamanja: { category: 'Instruments', id: 2840, label: 'Kamanja' },
  kaval: { category: 'Instruments', id: 2883, label: 'Kaval' },
  'khaen/khen': {
    category: 'Instruments',
    id: 2911,
    label: 'Khaen or Khen',
    contentLabel: 'Khaen/Khen',
  },
  'khaen or khen': {
    category: 'Instruments',
    id: 2911,
  ...
  khim: { category: 'Instruments', id: 2841, label: 'Khim' },
  khlui: { category: 'Instruments', id: 2884, label: 'Khlui' },
  'kong wong lek': { category: 'Instruments', id: 2795, label: 'Kong Wong Lek' },
  lute: { category: 'Instruments', id: 2844, label: 'Lute' },
  lyre: { category: 'Instruments', id: 2845, label: 'Lyre' },
  marranzano: { category: 'Instruments', id: 2900, label: 'Marranzano' },
  mizmar: { category: 'Instruments', id: 2912, label: 'Mizmar' },
  'morin khuur': { category: 'Instruments', id: 3797, label: 'Morin Khuur' },
  mridangam: { category: 'Instruments', id: 2799, label: 'Mridangam' },
  'musical bow/mouth bow': {
    category: 'Instruments',
    id: 2847,
    label: 'Musical Bow & Mouth Bow',
    contentLabel: 'Musical Bow/Mouth Bow',
  },
  'musical bow & mouth bow': {
    category: 'Instruments',
    id: 2847,
  ...
  'musical saw': { category: 'Instruments', id: 2977, label: 'Musical Saw' },
  'n goni': { category: 'Instruments', id: 2848, label: 'N Goni' },
  'native american flute': { category: 'Instruments', id: 2885, label: 'Native American Flute' },
  'ney or nay': { category: 'Instruments', id: 2886, label: 'Ney or Nay' },
  'non western brass instruments': {
    category: 'Instruments',
    id: 2771,
    label: 'Non Western Brass Instruments',
  },
  'non western flute': { category: 'Instruments', id: 2878, label: 'Non Western Flute' },
  'non western harp': {
    category: 'Instruments',
    id: 2838,
    label: 'Harp (Non-western)',
    contentLabel: 'Non Western Harp',
  },
  'harp (non-western)': {
    category: 'Instruments',
    id: 2838,
  ...
  'non western keyboard': { category: 'Instruments', id: 2774, label: 'Non Western Keyboard' },
  'non western mandolin': {
    category: 'Instruments',
    id: 2846,
    label: 'Mandolin (Non-western)',
    contentLabel: 'Non Western Mandolin',
  },
  'mandolin (non-western)': {
    category: 'Instruments',
    id: 2846,
    label: 'Mandolin (Non-western)',
    contentLabel: 'Non Western Mandolin',
  ...
  'non western marimba': {
    category: 'Instruments',
    id: 2797,
    label: 'Marimba (Non-western)',
    contentLabel: 'Non Western Marimba',
  },
  'marimba (non-western)': {
    category: 'Instruments',
    id: 2797,
  ...
  'non western pan pipes': {
    category: 'Instruments',
    id: 2889,
    label: 'Pan Pipes (Non-western)',
    contentLabel: 'Non Western Pan Pipes',
  },
  'pan pipes (non-western)': {
    category: 'Instruments',
    id: 2889,
    label: 'Pan Pipes (Non-western)',
    contentLabel: 'Non Western Pan Pipes',
  ...
  'non western penny whistle': {
    category: 'Instruments',
    id: 2890,
    label: 'Penny Whistle (Non-western)',
    contentLabel: 'Non Western Penny Whistle',
  },
  'penny whistle (non-western)': {
    category: 'Instruments',
    id: 2890,
    label: 'Penny Whistle (Non-western)',
    contentLabel: 'Non Western Penny Whistle',
  },
  'non western percussion': { category: 'Instruments', id: 2801, label: 'Non Western Percussion' },
  'non western violin': {
    category: 'Instruments',
    id: 2868,
    label: 'Violin (Non-western)',
    contentLabel: 'Non Western Violin',
  },
  'violin (non-western)': {
    category: 'Instruments',
    id: 2868,
  ...
  'novelty instruments': { category: 'Instruments', id: 2967, label: 'Novelty Instruments' },
  nyatiti: { category: 'Instruments', id: 2849, label: 'Nyatiti' },
  ocarina: { category: 'Instruments', id: 2887, label: 'Ocarina' },
  'overton whistle': { category: 'Instruments', id: 2888, label: 'Overton Whistle' },
  pekou: { category: 'Instruments', id: 2913, label: 'Pekou' },
  percussion: { category: 'Instruments', id: 2776, label: 'Percussion' },
  phin: { category: 'Instruments', id: 2851, label: 'Phin' },
  'pi chawa': { category: 'Instruments', id: 2901, label: 'Pi Chawa' },
  'pi nai/pi cha nai': {
    category: 'Instruments',
    id: 2902,
    label: 'Pi Nai or Pi Cha Nai',
    contentLabel: 'Pi Nai/Pi Cha Nai',
  },
  'pi nai or pi cha nai': {
    category: 'Instruments',
    id: 2902,
    label: 'Pi Nai or Pi Cha Nai',
    contentLabel: 'Pi Nai/Pi Cha Nai',
  },
  pipeau: { category: 'Instruments', id: 2891, label: 'Pipeau' },
  'pong lang': { category: 'Instruments', id: 2802, label: 'Pong Lang' },
  quanum: { category: 'Instruments', id: 2853, label: 'Quanum' },
  'rain stick': { category: 'Instruments', id: 2803, label: 'Rain Stick' },
  'ranat/ranad/ranaat': {
    category: 'Instruments',
    id: 2804,
    label: 'Ranat, Ranad or Ranaat',
    contentLabel: 'Ranat/Ranad/Ranaat',
  },
  'ranat, ranad or ranaat': {
    category: 'Instruments',
    id: 2804,
    label: 'Ranat, Ranad or Ranaat',
    contentLabel: 'Ranat/Ranad/Ranaat',
  },
  rebab: { category: 'Instruments', id: 2854, label: 'Rebab' },
  'req/riq/rik': {
    category: 'Instruments',
    id: 2805,
    label: 'Req, Riq or Rik',
    contentLabel: 'Req/Riq/Rik',
  },
  'req, riq or rik': {
    category: 'Instruments',
    id: 2805,
  ...
  ruan: { category: 'Instruments', id: 3796, label: 'Ruan' },
  'santur/santoor': {
    category: 'Instruments',
    id: 2855,
    label: 'Santur or Santoor',
    contentLabel: 'Santur/Santoor',
  },
  'santur or santoor': {
    category: 'Instruments',
    id: 2855,
  ...
  sarangi: { category: 'Instruments', id: 2856, label: 'Sarangi' },
  sarod: { category: 'Instruments', id: 2857, label: 'Sarod' },
  'saw duang/sor duang': {
    category: 'Instruments',
    id: 2858,
    label: 'Saw Duang or Sor Duang',
    contentLabel: 'Saw Duang/Sor Duang',
  },
  'saw duang or sor duang': {
    category: 'Instruments',
    id: 2858,
    label: 'Saw Duang or Sor Duang',
    contentLabel: 'Saw Duang/Sor Duang',
  },
  saz: { category: 'Instruments', id: 2859, label: 'Saz' },
  shawm: { category: 'Instruments', id: 2914, label: 'Shawm' },
  'shenai/shehnai': {
    category: 'Instruments',
    id: 2915,
    label: 'Shenai or Shehnai',
    contentLabel: 'Shenai/Shehnai',
  },
  'shenai or shehnai': {
    category: 'Instruments',
    id: 2915,
  ...
  sheng: { category: 'Instruments', id: 2916, label: 'Sheng' },
  shofar: { category: 'Instruments', id: 2903, label: 'Shofar' },
  'singing bowls': { category: 'Instruments', id: 2806, label: 'Singing Bowls' },
  'sintir/hajouj': {
    category: 'Instruments',
    id: 2861,
    label: 'Sintir & Hajouj',
    contentLabel: 'Sintir/Hajouj',
  },
  'sintir & hajouj': {
    category: 'Instruments',
    id: 2861,
  ...
  souna: { category: 'Instruments', id: 2917, label: 'Souna' },
  'spanish guitar': { category: 'Instruments', id: 2863, label: 'Spanish Guitar' },
  spoons: { category: 'Instruments', id: 2978, label: 'Spoons' },
  stringed: { category: 'Instruments', id: 2814, label: 'Stringed' },
  suling: { category: 'Instruments', id: 2893, label: 'Suling' },
  'swanee whistle': { category: 'Instruments', id: 2979, label: 'Swanee Whistle' },
  tambura: { category: 'Instruments', id: 2864, label: 'Tambura' },
  tar: { category: 'Instruments', id: 2865, label: 'Tar' },
  tiktiri: { category: 'Instruments', id: 2918, label: 'Tiktiri' },
  'ting sha': { category: 'Instruments', id: 2812, label: 'Ting Sha' },
  udu: { category: 'Instruments', id: 2813, label: 'Udu' },
  veena: { category: 'Instruments', id: 2866, label: 'Veena' },
  vielle: { category: 'Instruments', id: 2867, label: 'Vielle' },
  washboard: { category: 'Instruments', id: 2980, label: 'Washboard' },
  western: { category: 'Instruments', id: 2919, label: 'Western' },
  'wind, flute': { category: 'Instruments', id: 2872, label: 'Wind, Flute' },
  'wind, other': { category: 'Instruments', id: 2897, label: 'Wind, Other' },
  'wind, reed': { category: 'Instruments', id: 2905, label: 'Reeds', contentLabel: 'Wind, Reed' },
  reeds: { category: 'Instruments', id: 2905, label: 'Reeds', contentLabel: 'Wind, Reed' },
  wot: { category: 'Instruments', id: 2904, label: 'Wot' },
  xiao: { category: 'Instruments', id: 2894, label: 'Xiao' },
  xun: { category: 'Instruments', id: 2895, label: 'Xun' },
  'yangqin/yangxin': {
    category: 'Instruments',
    id: 2869,
    label: 'Yangqin & Yangxin',
    contentLabel: 'Yangqin/Yangxin',
  },
  'yangqin & yangxin': {
    category: 'Instruments',
    id: 2869,
  ...
  zhuieha: { category: 'Instruments', id: 2870, label: 'Zhuieha' },
  'zufalo flute': { category: 'Instruments', id: 2896, label: 'Zufalo Flute' },
};
...
export function parseQueryLocal(query) {
  ...
  for (let n = 3; n >= 2; n--) {
    for (let i = 0; i <= words.length - n; i++) {
      ...
      if (lookup) {
        const { category, id, label, contentLabel } = lookup;
        if (!filters[category]) {
          filters[category] = [];
        }
        ...
        if (!filters[category].includes(facetId)) {
          ...
          // facet = display label, contentLabel = Solr value (defaults to label if not specified)
          mappings.push({
            term: phrase,
            category,
            facet: label,
            contentLabel: contentLabel || label,
            id,
          });
        }
